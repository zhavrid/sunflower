    ...
    <footer>
        ...
        <div class="form">
            <!-- <div class="form_display">
                ...
                <select id="selectvalue" class="js-example-basic-multiple">
        ...
        <div class="footer_section">
            <div class="footer_section_block">
                <div class="footer_section_block_left">
                    <p><?php echo $fields['copyright']?></p> 
                </div>
                <div class="logo">
                    <?php echo wp_get_attachment_image($fields['logo'],'full'); ?>
                </div>
                <div class="footer_section_block_right">
